...
public class RomanChunkGenerator extends NoiseChunkGenerator<RomanGenSettings> {
    ...
    public RomanChunkGenerator(IWorld worldIn, BiomeProvider provider, RomanGenSettings settingsIn) {
