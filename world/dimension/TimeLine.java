...
public class TimeLine extends ForgeRegistryEntry<com.jjhjart.ancientcraft.api.dimension.TimeLine> implements com.jjhjart.ancientcraft.api.dimension.TimeLine {
    ...
    public static boolean isValidTimeLine(World world) {
        for (com.jjhjart.ancientcraft.api.dimension.TimeLine timeLine : ModRegistries.TIME_LINES) {
