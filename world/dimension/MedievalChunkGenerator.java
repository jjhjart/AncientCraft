...
public class MedievalChunkGenerator extends NoiseChunkGenerator<MedievalGenSettings> {
    ...
    public MedievalChunkGenerator(IWorld worldIn, BiomeProvider provider, MedievalGenSettings settingsIn) {
