...
public class CastleStructure extends Structure<NoFeatureConfig> {
    ...
    public CastleStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config) {
        super(config);
    }
    ...
    public IStartFactory getStartFactory() {
        return CastleStructure.Start::new;
    }

    @Override
    public String getStructureName() {
        return NewVoid.MOD_ID + ":castle";
    }
    ...
    public static class Start extends StructureStart {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
            ...
            CastlePieces.start(templateManagerIn, pos, rotation, this.components, this.rand);

            this.recalculateStructureSize();

       NewVoid.LOGGER.info("We can find a castle at: " + pos);
        }
    }
}
