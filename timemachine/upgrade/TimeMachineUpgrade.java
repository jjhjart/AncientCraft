package com.jjhjart.ancientcraft.timemachine.upgrade;
...
public class TimeMachineUpgrade extends ForgeRegistryEntry<com.jjhjart.ancientcraft.api.timemachine.upgrade.TimeMachineUpgrade> implements com.jjhjart.ancientcraft.api.timemachine.upgrade.TimeMachineUpgrade {
    ...
    public com.jjhjart.ancientcraft.api.timemachine.upgrade.TimeMachineUpgrade addHook(TimeMachineHook<?> hook) {
        addHook(hook, false);
        return this;
    }

    public com.jjhjart.ancientcraft.api.timemachine.upgrade.TimeMachineUpgrade addHook(TimeMachineHook<?> hook, boolean exclusiveMode) {
        this.hooks.put(hook, exclusiveMode);
        return this;
    }

    public com.jjhjart.ancientcraft.api.timemachine.upgrade.TimeMachineUpgrade addAllHooks(TimeMachineHook<?>... hooks) {
    ...
    public com.jjhjart.ancientcraft.api.timemachine.upgrade.TimeMachineUpgrade setCompatibleTMs(TimeMachine... compatibleTMs) {
