...
public class SpearEntity extends AbstractArrowEntity {
    ...
    private static final DataParameter<Boolean> field_226571_aq_ = EntityDataManager.createKey(SpearEntity.class, DataSerializers.BOOLEAN);
    private ItemStack thrownStack = new ItemStack(ModItems.PILUM.get());
    ...
    public SpearEntity(World worldIn, LivingEntity thrower, ItemStack thrownStackIn) {
        super(ModEntityTypes.PILUM.get(), thrower, worldIn);
    ...
    public SpearEntity(World worldIn, double x, double y, double z) {
        super(ModEntityTypes.PILUM.get(), x, y, z, worldIn);
    }
