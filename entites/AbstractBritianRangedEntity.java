...
public class AbstractBritianRangedEntity extends AbstractBritianEntity implements IRangedAttackMob {
    private final RangedBritianBowAttackGoal<AbstractBritianRangedEntity> aiArrowAttack = new RangedBritianBowAttackGoal<>(this, 1.0D, 20, 100.0F);
    private final MeleeAttackGoal aiAttackOnCollide = new MeleeAttackGoal(this, 1.2D, false) {
        ...
        public void resetTask() {
            super.resetTask();
            AbstractBritianRangedEntity.this.setAggroed(false);
        }
        ...
        public void startExecuting() {
            ...
            AbstractBritianRangedEntity.this.setAggroed(true);
        }
    };
    public AbstractBritianRangedEntity(EntityType<? extends AbstractBritianRangedEntity> type, World worldIn) {
        super(type, worldIn);
        this.setCombatTask();
    }
...
/*/
    ...
    public void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new RangedBritianBowAttackGoal<>(this, 1.0D, 20, 100.0F));
        ...
        this.goalSelector.addGoal(6, new LookAtGoal(this, MonsterEntity.class, 20.0F));
    ...
    protected void registerAttributes() {
        ...
        //this.getAttribute(SharedMonsterAttributes.FOLLOW_RANGE).setBaseValue(200.0d); //
    }
