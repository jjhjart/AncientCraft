...
public class RangedBritianBowAttackGoal<T extends MonsterEntity & IRangedAttackMob> extends Goal {
    ...
    public RangedBritianBowAttackGoal(T mob, double moveSpeedAmpIn, int attackCooldownIn, float maxAttackDistanceIn) {
        this.entity = mob;
        this.moveSpeedAmp = moveSpeedAmpIn;
        this.attackCooldown = attackCooldownIn;
        this.maxAttackDistance = maxAttackDistanceIn * maxAttackDistanceIn + 100;
