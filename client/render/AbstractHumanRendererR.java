...
public class AbstractHumanRendererR extends BipedRenderer<AbstractRomanEntity, AbstractHumanModel<AbstractRomanEntity>> {
    protected static final ResourceLocation TEXTURE = new ResourceLocation(NewVoid.MOD_ID,
            "textures/entity/kaila_roman_skin.png");

    @SuppressWarnings("rawtypes")
    public AbstractHumanRendererR(EntityRendererManager renderManagerIn) {
