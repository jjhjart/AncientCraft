...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractHumanRomeRenderer<T extends AbstractRomanEntity, M extends HumanRomeModel<T>> extends BipedRenderer<T, M> {
    private static final ResourceLocation field_217771_a = new ResourceLocation(NewVoid.MOD_ID, "textures/entity/theguard.png");

    protected AbstractHumanRomeRenderer(EntityRendererManager p_i50974_1_, M p_i50974_2_, M p_i50974_3_, M p_i50974_4_) {
