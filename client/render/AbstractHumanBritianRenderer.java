...
import com.jjhjart.ancientcraft.client.model.HumanBritianModel;
import com.jjhjart.ancientcraft.client.model.HumanRomeModel;
...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractHumanBritianRenderer<T extends AbstractBritianEntity, M extends HumanBritianModel<T>> extends BipedRenderer<T, M> {
    private static final ResourceLocation field_217771_a = new ResourceLocation(NewVoid.MOD_ID, "textures/entity/knight.png");

    protected AbstractHumanBritianRenderer(EntityRendererManager p_i50974_1_, M p_i50974_2_, M p_i50974_3_, M p_i50974_4_) {
