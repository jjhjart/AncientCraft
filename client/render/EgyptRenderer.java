...
public class EgyptRenderer extends AbstractHumanRomeRenderer{

    private static final ResourceLocation TEXTURE = new ResourceLocation(NewVoid.MOD_ID, "textures/entity/egypt.png");

    public EgyptRenderer(EntityRendererManager renderManagerIn) {
