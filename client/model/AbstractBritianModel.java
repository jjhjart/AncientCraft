...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractBritianModel<T extends MonsterEntity> extends BipedModel<T> {
    protected AbstractBritianModel(float p_i51070_1_, float p_i51070_2_, int p_i51070_3_, int p_i51070_4_) {
