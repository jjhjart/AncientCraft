...
@OnlyIn(Dist.CLIENT)
public class BipedRomeModel<T extends LivingEntity> extends AgeableModel<T> implements IHasArm, IHasHead {
    ...
    public net.minecraft.client.renderer.entity.model.BipedModel.ArmPose leftArmPose = net.minecraft.client.renderer.entity.model.BipedModel.ArmPose.EMPTY;
    public net.minecraft.client.renderer.entity.model.BipedModel.ArmPose rightArmPose = net.minecraft.client.renderer.entity.model.BipedModel.ArmPose.EMPTY;
    public boolean isSneak;
    public float swimAnimation;
    private float remainingItemUseTime;

    public BipedRomeModel(float modelSize) {
        this(RenderType::getEntityCutoutNoCull, modelSize, 0.0F, 64, 32);
    }

    protected BipedRomeModel(float modelSize, float yOffsetIn, int textureWidthIn, int textureHeightIn) {
        this(RenderType::getEntityCutoutNoCull, modelSize, yOffsetIn, textureWidthIn, textureHeightIn);
    }

    public BipedRomeModel(Function<ResourceLocation, RenderType> renderTypeIn, float modelSizeIn, float yOffsetIn, int textureWidthIn, int textureHeightIn) {
    ...
    public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        switch(this.rightArmPose) {
            ...
            case THROW_SPEAR:
                ...
                this.bipedRightArm.rotateAngleY = 90.0F;
        }

        if (this.leftArmPose == net.minecraft.client.renderer.entity.model.BipedModel.ArmPose.THROW_SPEAR && this.rightArmPose != net.minecraft.client.renderer.entity.model.BipedModel.ArmPose.BLOCK && this.rightArmPose != net.minecraft.client.renderer.entity.model.BipedModel.ArmPose.THROW_SPEAR && this.rightArmPose != net.minecraft.client.renderer.entity.model.BipedModel.ArmPose.BOW_AND_ARROW) {
        ...
        if (this.rightArmPose == net.minecraft.client.renderer.entity.model.BipedModel.ArmPose.BOW_AND_ARROW) {
            this.bipedRightArm.rotateAngleY = -0.1F + this.bipedHead.rotateAngleY;
            this.bipedLeftArm.rotateAngleY = 0.1F + this.bipedHead.rotateAngleY + 0.4F;
            this.bipedRightArm.rotateAngleX = (-(float)Math.PI / 2F) + this.bipedHead.rotateAngleX;
            this.bipedLeftArm.rotateAngleX = (-(float)Math.PI / 2F) + this.bipedHead.rotateAngleX;
        } else if (this.leftArmPose == net.minecraft.client.renderer.entity.model.BipedModel.ArmPose.BOW_AND_ARROW && this.rightArmPose != net.minecraft.client.renderer.entity.model.BipedModel.ArmPose.THROW_SPEAR && this.rightArmPose != net.minecraft.client.renderer.entity.model.BipedModel.ArmPose.BLOCK) {
        ...
        if (this.rightArmPose == net.minecraft.client.renderer.entity.model.BipedModel.ArmPose.CROSSBOW_CHARGE) {
        ...
        } else if (this.leftArmPose == net.minecraft.client.renderer.entity.model.BipedModel.ArmPose.CROSSBOW_CHARGE) {
        ...
        if (this.rightArmPose == net.minecraft.client.renderer.entity.model.BipedModel.ArmPose.CROSSBOW_HOLD && this.swingProgress <= 0.0F) {
        ...
        } else if (this.leftArmPose == net.minecraft.client.renderer.entity.model.BipedModel.ArmPose.CROSSBOW_HOLD) {
    ...
    public void setModelAttributes(net.minecraft.client.renderer.entity.model.BipedModel<T> modelIn) {
