...
@OnlyIn(Dist.CLIENT)
public class HumanRomeModel<T extends AbstractRomanEntity> extends AbstractHumanRomeModel<T> {
    public HumanRomeModel(float modelSize, boolean p_i1168_2_) {
        this(modelSize, 0.0F, 64, p_i1168_2_ ? 32 : 64);
    }

    protected HumanRomeModel(float p_i48914_1_, float p_i48914_2_, int p_i48914_3_, int p_i48914_4_) {
