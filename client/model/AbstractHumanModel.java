...
public class AbstractHumanModel<T extends MonsterEntity> extends BipedModel<T> {
    ...
    public AbstractHumanModel() {
        this(0.0F, false);
    }

    public AbstractHumanModel(float modelSize, boolean smallArmsIn) {
