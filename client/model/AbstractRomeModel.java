...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractRomeModel<T extends MonsterEntity> extends BipedModel<T> {
    protected AbstractRomeModel(float p_i51070_1_, float p_i51070_2_, int p_i51070_3_, int p_i51070_4_) {
