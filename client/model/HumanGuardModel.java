...
@OnlyIn(Dist.CLIENT)
public class HumanGuardModel<T extends AbstractRomanEntity> extends HumanRomeModel<T> {
    public HumanGuardModel(float p_i48915_1_, float p_i48915_2_, int p_i48915_3_, int p_i48915_4_) {
    ...
    public HumanGuardModel(float p_i49398_1_, boolean p_i49398_2_) {
